...
namespace COMP003A.LectureActivity5
{
    internal class Program
    {
         ...
         * <summary></summary> used to describe a type membe
         * <param name="nameOfTheParameter"></param> used for describing one or more parameters in the method signature<returns></returns> used to describe the return value
         *
